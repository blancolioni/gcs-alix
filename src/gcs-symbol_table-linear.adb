...
--                                                                          --
--              G C S . S Y M B O L _ T A B L E . L I N E A R               --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
--                            $Revision: 1.1.1.1 $                              --
...
package body GCS.Symbol_Table.Linear is
   ...
   begin
      ...
      while not Off_Right (It) loop
         if GCS.Symbol_Table.Name (Current (It)) = Name then
            if E = null then
               E := Current (It);
               Result := Found;
            else
...
--       end if;
   ...
   begin
      ...
      while not Off_Right (T.Pos) loop
         if GCS.Symbol_Table.Name (Current (T.Pos)) = Name then
